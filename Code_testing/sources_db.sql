...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2026 at 04:49 PM
...
CREATE TABLE `sources_db` (
  ...
  `Source type` varchar(18) DEFAULT NULL,
...
INSERT INTO `sources_db` (`SourceID`, `Source`, `Source type`, `School`, `Department`, `Notes`, `Hyperlink`) VALUES
