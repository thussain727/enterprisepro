...
<div class="childpagecontent"> <!-- Main content container holding page text and table -->
    ...
    $school = $_POST['School']; //Grabs post variables from search page and uses string manipulation to insert them into a query
    $school = "'".$school."'";
    $sourcetype = $_POST['Sourcetype'];
    $sourcetype = "'".$sourcetype."'";
    $sqlquery = "SELECT * FROM sources_db WHERE School=$school AND Source_type= $sourcetype";
    $results = $conn1->query($sqlquery); //Query Execution, results are echoed into a table on the page; if no hyperlink is provided, this is stated
     echo "<table>
          <tr>
            <th>Source ID</th>
            <th>Source</th>
